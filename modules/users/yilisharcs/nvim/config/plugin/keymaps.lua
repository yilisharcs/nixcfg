...
vim.keymap.set({ "n", "x", "i", "c", "t" }, "<C-SPACE>!", "<CMD>1tabnext<CR>")
vim.keymap.set({ "n", "x", "i", "c", "t" }, "<C-SPACE>@", "<CMD>2tabnext<CR>")
vim.keymap.set({ "n", "x", "i", "c", "t" }, "<C-SPACE>#", "<CMD>3tabnext<CR>")
vim.keymap.set({ "n", "x", "i", "c", "t" }, "<C-SPACE>$", "<CMD>4tabnext<CR>")
vim.keymap.set({ "n", "x", "i", "c", "t" }, "<C-SPACE>%", "<CMD>5tabnext<CR>")
vim.keymap.set({ "n", "x", "i", "c", "t" }, "<C-SPACE>^", "<CMD>6tabnext<CR>")
vim.keymap.set({ "n", "x", "i", "c", "t" }, "<C-SPACE>&", "<CMD>7tabnext<CR>")
vim.keymap.set({ "n", "x", "i", "c", "t" }, "<C-SPACE>*", "<CMD>8tabnext<CR>")
vim.keymap.set({ "n", "x", "i", "c", "t" }, "<C-SPACE>(", "<CMD>9tabnext<CR>")
